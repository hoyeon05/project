// server.js
// EveryBus 백엔드 — MongoDB Atlas 구조 대응 버전
// (위치.type="Point", coordinates=[lng, lat] 구조를 자동 해석)
...
const VehicleSchema = new mongoose.Schema(
  {
    id: { type: String, required: true, unique: true }, // 버스 IMEI
...
// 🚏 정류장 정보 (DB 구조: 위치: { type: "Point", coordinates: [lng, lat] })
